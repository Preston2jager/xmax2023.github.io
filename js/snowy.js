...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function set(config) {
      config.frequency = config.frequency ? config.frequency : 15;
      config.radiusRange = config.radiusRange ? config.radiusRange : [0.5, 4];
      config.speedRange = config.speedRange ? config.speedRange : [0.5, 1];
      config.angleRange = config.angleRange ? config.angleRange : [-1, 1];
      config.colors = config.colors ? typeof config.colors === "string" ? JSON.parse(config.colors) : config.colors : ["#fff"];
      config.type = config.type ? config.type : "text";
